        ...
        <div className='singleProject'>
            ...
            <div className='singleProject__right'>
                ...
                <div className='skills__links'>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[0].code}><GitHubIcon/></a>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[0].demo}><LinkIcon/></a>
                </div>
            </div>
        </div>
        <div className='singleProject'>
            ...
            <div className='singleProject__right'>
                ...
                <div className='skills__links'>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[1].code}><GitHubIcon/></a>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[1].demo}><LinkIcon/></a>
                </div>
            </div>
        </div>
        <div className='singleProject'>
            ...
            <div className='singleProject__right'>
                ...
                <div className='skills__links'>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[2].code}><GitHubIcon/></a>
                    <a target="_blank" rel="noreferrer" href={featuredProjects[2].demo}><LinkIcon/></a>
                </div>
            </div>
        </div>
        </div>
